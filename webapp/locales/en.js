export default {
  ...
  "Please type your collection description":
    "Please type your collection description.",
  "Please type your collection royalty recipient":
    "Please type your collection royalty recipient.",
  ...
  "This image will be used for navigation":
    "This image will be used for navigation. 300x300 recommended.",
  "This image will also be used for collection detail":
    "This image will also be used for collection detail. 1200x300 recommended.",
  "Provide your description for your collection":
    "Provide your description for your collection",
  "Customize your URL on MXC loT NFT Marketplace":
    "Customize your URL on MXC loT NFT Marketplace.",
  "You must have MXC Domains to assign to the URL":
    "You must have MXC Domains to assign to the URL.",
  ...
  "Collection owners can colelct creator earnings":
    "Collection owners can colelct creator earnings when a user re-sells an item they created. Contract the collection onwer to change the collection earnings percentage or the payout address",
  ...
  "Approve successfully Now you can List for sale":
    "Approve successfully. Now you can List for sale!",
  ...
  "uses LPWAN and NFC technology to track":
    "uses LPWAN and NFC technology to track, authenticate, and submit location proofs for the real world collectables.",
  ...
  "The description will be inclueded on the item":
    "The description will be inclueded on the item's detail page unserneath its image.",
  ...
  "The proofs of location for IoT NFTs":
    "The proofs of location for IoT NFTs will be prominently displayed on the dedicated product exhibition page for each device. For the purpose of provisioning a tag, an MXC N3XUS is necessary. You can find more details on the provisioning process by visiting this link",
